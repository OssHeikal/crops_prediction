...
extension TextStyleEx on TextStyle {
  ...
  TextStyle setWordSpacingPercent(double value) => copyWith(wordSpacing: value);
  TextStyle setLetterSpacingPercent(double value) => copyWith(letterSpacing: value);
  TextStyle setTextBaseline(TextBaseline baseline) => copyWith(textBaseline: baseline);
}
